...
export function CartDrawer() {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={closeCart}>
      <SheetContent side="right" className="w-full sm:max-w-lg bg-dark-900 border-dark-700">
        <SheetHeader className="border-b border-dark-700 pb-4">
          <SheetTitle className="text-2xl font-bold text-gray-100 flex items-center gap-2">
        ...
        {items.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-[50vh] text-center">
            ...
            <p className="text-gray-500 text-sm mb-6">Add some hoodies to get started</p>
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto py-6 space-y-4">
              {items.map((item) => (
                <div key={item.id} className="flex gap-4 bg-dark-800 rounded-lg p-4">
            ...
            <div className="border-t border-dark-700 pt-4 space-y-4">
              ...
              <Button onClick={closeCart} variant="outline" className="w-full bg-transparent">
                Continue Shopping
              </Button>
            </div>
          </div>
